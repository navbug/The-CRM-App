      ...
      <header className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <nav className="text-sm flex items-center">
            <NavLink to="/content/pages" className="text-gray-600 hover:text-gray-700 underline font-bold">Content</NavLink>
            ...
            <span className="text-gray-600 font-bold">Page Name</span>
          </nav>
        </div>
          ...
          {isOptionsOpen && (
            <div className="absolute top-8 right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
              <div className="py-1">
                ...
                <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Edit Page</a>
                <a href="#" className="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100">Delete Page</a>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="w-full">
          ...
          <div className="w-full min-h-64 space-y-4 flex flex-col bg-white rounded-sm shadow-md p-4 flex-grow gap-4">
            ...
            <div className='hover:bg-gray-100 p-2'>
              ...
              <br />
              Hi <span className='font-semibold'>@clientName</span>,
              <br /><br />
              I'd like to share Page Name with you, via the link below. Please let me know if I can help answer any questions

            </div>
          </div>

          <div className='text-gray-600 px-2 py-4 font-semibold'>Page last updated 15 Jul 2024. Created 15 Jul 2024.</div>
        </div>
          ...
          <div className='bg-white rounded-sm shadow-md p-6 flex-grow '>
            <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <p className="text-sm font-semibold text-gray-500">Jul 10, 2024 02:33 PM</p>
                  <p className="font-semibold">Page Created</p>
                </div>
              </div>
            </div>
          </div>
