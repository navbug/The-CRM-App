...
const AllClients = () => {
  ...
  const filteredClients = useMemo(() => {
    return clientsInformation.filter((client) => {
  ...
  }, [clientsInformation, searchQuery, selectedGroups]);
  ...
  if (clientsInformation.length === 0) {
    return <NoDataWrapper>No Clients Found.</NoDataWrapper>;
  }
  ...
  return (
    <div className="p-4">
      ...
      {filteredClients.length === 0 ? (
        <NoDataWrapper height={10}>No Client</NoDataWrapper>
      ) : (
          ...
          <tbody>
            {filteredClients.map((client) => (
              ...
              >
                ...
                <td className="py-3 px-4">{client?.notes || "-"}</td>
